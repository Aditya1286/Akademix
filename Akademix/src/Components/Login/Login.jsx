        ...
        <div className="p-6">
            ...
            <div className="text-center mt-6">
                <p className="text-gray-600">Already have an account? 
                    <button id="signInButton" className="text-blue-600 hover:text-blue-800 
                    font-semibold hover:underline ml-1 transition duration-300" onClick={handler}>Sign In</button>
                </p>
            </div>
        </div>
    </div>
        ...
        <div className="p-6">
            ...
            <div className="text-center mt-6">
                <p className="text-gray-600">Don't have an account? 
                    <button id="signUpButton" className="text-blue-600 hover:text-blue-800 font-semibold hover:underline ml-1 transition duration-300" onClick={handler}>Sign Up</button>
                </p>
            </div>
        </div>
    </div>
