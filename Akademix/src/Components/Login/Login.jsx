      ...
      <div className={`max-w-md w-full bg-white rounded-xl shadow-lg overflow-hidden ${visible ? "" : "hidden"}`}>
        ...
        <div className="p-6">
          <form method="post" onSubmit={onSubmit} className="space-y-6">
            <input type="text" placeholder="First Name" required value={fname} onChange={(e) => setFname(e.target.value)} className="w-full border-b-2 border-gray-300 pb-2 focus:border-blue-600" />
            <input type="text" placeholder="Last Name" required value={lname} onChange={(e) => setLname(e.target.value)} className="w-full border-b-2 border-gray-300 pb-2 focus:border-blue-600" />
            <input type="email" placeholder="Email" required value={email} onChange={(e) => setEmail(e.target.value)} className="w-full border-b-2 border-gray-300 pb-2 focus:border-blue-600" />
            <input type="password" placeholder="Password" required value={password} onChange={(e) => setPassword(e.target.value)} className="w-full border-b-2 border-gray-300 pb-2 focus:border-blue-600" />
