...
function Happenings({ Heading = "Happenings" }) {
    ...
    <>
        <div className='w-full h-full bg-white overflow-hidden'>
            <div className='header w-full h-[12%] items-center pl-2  bg-gray-300 flex text-xl font-semibold'>
                <p>Happenings</p>
            </div>
            <div className='w-full h-[85%] flex flex-col gap-3 mt-3 overflow-hidden overflow-y-auto text-xs pl-5  font-bold'>
            {data.map((data)=>(
